...
const main = (): void => {
  ...
  const buildMocha = async (): Promise<void> => {
    do {
      ...
      menuChoice = parseInt(optionPicked) as number;
      switch (menuChoice) {
        case 0: {
          break;
        }
